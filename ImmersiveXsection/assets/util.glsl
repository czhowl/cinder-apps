...
vec4 snoiseVec4( vec4 x ){
  ...
  float s1 = snoise(vec4( x.y - 19.1 , x.w + 33.4 , x.x + 47.2, x.z - 25.6 ));
  float s2 = snoise(vec4( x.z + 74.2 , x.x - 124.5 , x.w - 143.8, x.y + 99.4 ));
  float s3 = snoise(vec4( x.w - 48.3 , x.z + 20.8 , x.y + 2.8, x.x - 89.3 ));
...
vec4 curlNoise( vec4 p ){
    ...
    float x = p_y1.z - p_y0.z - p_z1.w + p_z0.w + p_w1.y - p_w0.y;
    float y = p_z1.x - p_z0.x - p_x1.w + p_x0.w - p_w1.z + p_w0.z;
    float z = p_x1.y - p_x0.y - p_y1.w + p_y0.w + p_w1.x - p_w0.x;
    float w = - p_x1.z + p_x0.z + p_y1.x - p_y0.x - p_z1.y + p_z0.y;

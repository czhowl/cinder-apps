...
class realsense2App : public App {
  public:
	void    setup() override;
...
void realsense2App::mouseDown( MouseEvent event )
{
}

void realsense2App::update()
{
...
void realsense2App::draw()
{
	gl::clear( Color( 0, 0, 0 ) );
    gl::setMatrices( mCamera );
    gl::color(Color(1,1,1));
    gl::drawSphere(glm::vec3(0), dist_to_center + 1);
}

void realsense2App::print_device_info(rs2_device* dev)
{
    rs2_error* e = 0;
...
void realsense2App::check_error(rs2_error* e)
{
    if (e)
    {
...
float realsense2App::get_depth_unit_value(const rs2_device* const dev)
{
    rs2_error* e = 0;
...
void realsense2App::cleanup(){
    console() << "cleanning up" << endl;
...
CINDER_APP( realsense2App, RendererGl )
